...
package Opus.Decoders is
   ...
   procedure Destroy (Decoder : Decoder_Data);
   ...
   procedure Reset_State (Decoder : Decoder_Data);
   ...
   function Get_Bandwidth (Decoder : Decoder_Data) return Bandwidth;
   --  Gets the decoder's last bandpass.
   --
   --  Raises No_Packets_Decoded if no packets have been decoded yet.

   function Get_Channels (Decoder : Decoder_Data) return Channel_Type;
   ...
   function Get_Final_Range (Decoder : Decoder_Data) return Integer;
   ...
   function Get_Last_Packet_Duration (Decoder : Decoder_Data) return Natural;
